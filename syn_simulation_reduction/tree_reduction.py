...
# Data (same as before)
r6_0 = [6242.017, 6076.006, 36782.366, 193609.064, 244350.283, 47612.691, 180686.55, 184447.219, 100502.83]
r6_1 = [153869.259, 149926.258, None, None, None, None, None, None, None]
r6_2 = [84045.708, 82692.224, None, None, None, None, None, None, None]

r30_0 = [3990.752, 3957.8, 73557.827, None, None, 94139, None, None, 199970.763]
r30_1 = [79778.219, 79442.459, None, None, None, None, None, None, None]
r30_2 = [42563.959, 41731.92, None, None, None, None, None, None, None]

r100_0 = [8891.533, 10637.824, 110096.602, None, None, 139263.366, None, None, 286507.081]
r100_1 = [55994.499, 56324.669, None, None, None, None, None, None, None]
r100_2 = [22646.117, 22403.92, None, None, None, None, None, None, None]
...
plt.savefig("tree_simulation.pdf", format='pdf')
# Show the plot
plt.show()
