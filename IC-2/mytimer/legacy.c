...
// int switchUart = 0;
// int delayCycles = 0;
//char g_riftUnitCounterCounter = 0;
//char g_testDriftIntervals = 1000;
//
//int a = 0;
//int b = 0;
//int c = 0;
...
//    P4OUT &= ~BIT1;           // Clear P1.0 output latch for a defined power-on state
//    P4DIR |= BIT1;            // Set P1.0 to output direction
//    // Configure GPIO
//    P6SEL1 &= ~(BIT0 | BIT1);
...
//{
//    P4OUT ^= BIT1;
////    if (g_testDriftIntervals > 0)
////    {
////        TA0CCR0 += DELAYUNIT;
////        g_testDriftIntervals = g_testDriftIntervals
////    }
////    else
////    {
////        TA0CCR0 += DRIFTUNIT;
////    }
//    if (g_riftUnitCounterCounter != 0)
//    {
//        TA0CCR0 += DRIFTUNIT;
//        g_riftUnitCounterCounter = g_riftUnitCounterCounter - 1;
//
//    }
//    else
//    {
...
//        RXData = UCA3RXBUF;
//        __no_operation();
//        if ((RXData != 0x56) && (RXData != 0) && (g_riftUnitCounterCounter == 0))
//        {
//            g_riftUnitCounterCounter = RXData;
//        }
