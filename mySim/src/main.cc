...
void basic_node::treeReduce()
{
    // if ((ic_index % 2) == 0)
    // {
    //     int passNum = pckt->getPass_counter();
    //     if (ic_index != 0)
    //     {
    //         if (passNum >= 1)
    //         {
    //             this->virtual_ic_id = int(log2(virtual_ic_id));
    //             if (((this->virtual_ic_id % 2) == 0) && ((this->g_ic_dynamic_loc + 2) < this->g_ic_num))
    //             {
    //                 this->g_reduction_bias_num = 2;
    //                 this->g_if_reduction_recovery = true;
    //                 this->g_ic_dynamic_loc = this->g_ic_dynamic_loc + 2;
    //             }
    //         }
    //         else
    //         {
    //             if ((this->g_ic_dynamic_loc + 1) < this->g_ic_num)
    //             {
    //                 this->g_reduction_bias_num = 1;
    //                 this->g_if_reduction_recovery = true;
    //                 this->g_ic_dynamic_loc = this->g_ic_dynamic_loc + 1;
    //             }
    //         }
    //     }
    //     else
    ...
    //             if ((this->g_ic_dynamic_loc + 1) < this->g_ic_num)
    //             {
    //                 this->g_ic_dynamic_loc = g_ic_dynamic_loc + 1;
    //             }
    //         }
    //         else
    //         {
    //             if ((this->g_ic_dynamic_loc + 2) < this->g_ic_num)
    //             {
    //                 this->g_ic_dynamic_loc = g_ic_dynamic_loc + 2;
    //             }
    //         }
    //     }
    // }
...
{
    // // in linked-list reduce, the first node is the initialization node
    // if (ic_index < (this->g_ic_num - 1))
    // {
    //     pckt->setNext_id(ic_index + 1);
    //     this->g_reduction_bias_num = 1;
    //     this->g_if_reduction_recovery = true;
    //     this->g_ic_dynamic_loc = g_ic_dynamic_loc + 1;
    //     this->networkPtr->getSubmodule("ic", g_ic_dynamic_loc)->g_if_takeup = true;
    // }
}
