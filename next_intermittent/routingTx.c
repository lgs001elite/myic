...
#include "source_DB.h"
const      uint32_t       g_file_len               = 2300;
...
//#pragma CODE_SECTION(produceData,".run_from_ram")
void produceData(void)
{
    ...
    for (; i < MAXQUELEN; i++)
    {
        ...
        g_packetQueue[g_queueLen].dst = g_dest_address;
...
void produceNonPacketData(void)
{
    ...
    g_transBuffer[5] = g_dest_address;
