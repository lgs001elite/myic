...
plt.rcParams['text.latex.preamble'] = "\\usepackage[libertine]{newtxmath}"
...
fig, ax = plt.subplots(5, 1, figsize=(10, 10), layout="constrained")
ax[0].plot(car01, label="Node1")
# ax[0].plot(car02, label="Node2")
x1, x2, y1, y2 = 200, 300, 300, 2500  # subregion of the original image
axins = ax[0].inset_axes([0.5, 0.5, 0.47, 0.45],xlim=(x1, x2), ylim=(y1, y2))
axins.set_xticks([])
axins.set_yticks([])
axins.plot(car01)
#axins.plot(car02)
ax[0].indicate_inset_zoom(axins, edgecolor="gray", alpha=0.5) # alpha: transpancy
ax[0].set_xticks([])
...
axins = ax[1].inset_axes([0.5, 0.5, 0.47, 0.45],xlim=(x1, x2), ylim=(y1, y2))
axins.set_xticks([])
axins.set_yticks([])
axins.plot(jogging01)
#axins.plot(jogging02)
ax[1].indicate_inset_zoom(axins, edgecolor="gray", alpha=1)
ax[1].set_xticks([])
...
ax[2].set_xticks([])
# ax[2].plot(office02)
x1, x2, y1, y2 = 200, 220, 89, 94  # subregion of the original image
axins = ax[2].inset_axes([0.5, 0.5, 0.1, 0.45],xlim=(x1, x2), ylim=(y1, y2))
axins.set_xticks([])
axins.set_yticks([])
axins.plot(office01)
# axins.plot(jogging02)
ax[2].indicate_inset_zoom(axins, edgecolor="gray", alpha=1)

ax[3].plot(stairs01)
# ax[3].plot(stairs02)
x1, x2, y1, y2 = 670, 690, 46, 49  # subregion of the original image
axins = ax[3].inset_axes([0.8, 0.5, 0.1, 0.45],xlim=(x1, x2), ylim=(y1, y2))
axins.set_xticks([])
axins.set_yticks([])
axins.plot(stairs01)
#axins.plot(stairs02)
ax[3].indicate_inset_zoom(axins, edgecolor="gray", alpha=1)
ax[3].set_xticks([])
...
ax[4].plot(washer01)
# ax[4].plot(washer02)
x1, x2, y1, y2 = 770, 800, 45, 50  # subregion of the original image
axins = ax[4].inset_axes([0.8, 0.5, 0.1, 0.45],xlim=(x1, x2), ylim=(y1, y2))
axins.set_xticks([])
axins.set_yticks([])
axins.plot(stairs01)
#axins.plot(stairs02)
ax[4].indicate_inset_zoom(axins, edgecolor="gray", alpha=1)
...
ax[2].set_ylabel('Charging Time (ms)')
# ax[3].set_ylabel('[Slots]')
# ax[4].set_ylabel('[Slots]')
ax[4].set_xlabel('Charging Cycle Sequence', loc="center")
...
plt.savefig("../../figures/real_traces" + ".pdf", format="pdf", bbox_inches="tight")
#plt.show()
plt.close("all")
