...
def subTask(fb_size, icNums, logger, poweroffLabel):
    ...
    #     futuresMoreTasks.append(executorMore.submit(sub_subTask, scenario, fb_size, icNums, logger, poweroffLabel))
...
if __name__ == "__main__":
    ...
    poweroffLabel = "no_poweroff_100_general_"
    print(poweroffLabel)
    ...
    for i in range(lengthNodeSet):
        # Create log
        logfilename = poweroffLabel+str(general_nodeset[i]) +"_results"
        ...
        # futuresTasks.append(executor.submit(subTask, Free_beacon_size, general_nodeset[i], logger, poweroffLabel))
