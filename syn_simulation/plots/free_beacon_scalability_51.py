...
if __name__ == "__main__":
    ...
    for i in range(lengthNodeSet):
        # Create log
        logfilename = poweroffLabel+str(scalability_nodeset[i]) +"_results"
        ...
        # futuresTasks.append(executor.submit(subTask,Free_beacon_size, scalability_nodeset[i], logger, poweroffLabel))
