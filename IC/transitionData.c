...
void s2m(SPI_DATAGRAM *m_transData, uint8_t s_transData[])
{
    ...
    m_transData->p_len = s_transData[7];
...
void m2s(uint8_t * s_transData, SPI_DATAGRAM * m_transData)
{
    ...
    s_transData[8]  = m_transData->round;
    ...
    s_transData[32] = (crc_result & 0xFF00) >> 8;
    s_transData[33] = (crc_result & 0x00FF);
